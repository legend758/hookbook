...
echo ' Source:  ';
 ...
 mysqli_query($SQL,"INSERT INTO booking_history (user_id,source,date,time_booking,time_journey)
VALUES ('$user_id','$source','$date',Now(),'$time')");
 
 $SQL = mysqli_connect("localhost","root","","hookbus_datadase");
	if(mysqli_connect_errno())
	{
		printf("connection error!!!...plz try again later");
		exit();
