...
<div id="container">
    ...
    <!-- <div class="pic"><img src="images/pic.jpg" width="150" /></div> -->
     <!-- <h2 class="style3">Welcome to Travel Triangle</h2> -->
      <form name="input"  method="get" action="student_homepage.php">
<table border="0">
...
<tr>
<td></td>	<td><input type="radio" name="user_category" value="student">Student</td>
</tr>
<tr>
<td>Category:</td>	<td><input type="radio" name="user_category" value="admin">Admin</td>
</tr>
<tr>
<tr>
